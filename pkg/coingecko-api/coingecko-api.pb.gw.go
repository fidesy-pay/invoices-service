...
func RegisterCoinGeckoAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CoinGeckoAPIServer) error {
	...
	mux.Handle("POST", pattern_CoinGeckoAPI_GetPrice_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/coingecko_api.CoinGeckoAPI/GetPrice", runtime.WithHTTPPathPattern("/price"))
		if err != nil {
...
func RegisterCoinGeckoAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CoinGeckoAPIClient) error {
	...
	mux.Handle("POST", pattern_CoinGeckoAPI_GetPrice_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/coingecko_api.CoinGeckoAPI/GetPrice", runtime.WithHTTPPathPattern("/price"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_CoinGeckoAPI_GetPrice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"price"}, ""))
)
